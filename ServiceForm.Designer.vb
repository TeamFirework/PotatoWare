...
Partial Class ServiceForm
    ...
    Private Sub InitializeComponent()
        ...
        Me.ServiceTick = New System.Windows.Forms.Timer(Me.components)
        Me.SuspendLayout()
        '
        'ServiceTick
        '
        Me.ServiceTick.Interval = 5000
        '
        'ServiceForm
        '
        ...
        Me.Text = "PotatoWare Service"
        Me.ResumeLayout(False)

    End Sub

    Friend WithEvents ServiceTick As Timer
End Class
